...
// Fri May 10 12:14:03 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/May10_mu_5GeV_10events_run_1.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef May10_muon_count_10_h
#define May10_muon_count_10_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 113686;
   static constexpr Int_t kMax_HcalBarrelHits_MCParticle = 113686;
   static constexpr Int_t kMaxMCParticles = 694114;
   static constexpr Int_t kMax_MCParticles_parents = 694113;
   static constexpr Int_t kMax_MCParticles_daughters = 694113;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   May10_muon_count_10(TTree *tree=0);
   virtual ~May10_muon_count_10();
...
#ifdef May10_muon_count_10_cxx
May10_muon_count_10::May10_muon_count_10(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/May10_mu_5GeV_10events_run_1.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/May10_mu_5GeV_10events_run_1.edm4hep.root");
      }
...
May10_muon_count_10::~May10_muon_count_10()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t May10_muon_count_10::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t May10_muon_count_10::LoadTree(Long64_t entry)
{
...
void May10_muon_count_10::Init(TTree *tree)
{
...
Bool_t May10_muon_count_10::Notify()
{
...
void May10_muon_count_10::Show(Long64_t entry)
{
...
Int_t May10_muon_count_10::Cut(Long64_t entry)
{
...
#endif // #ifdef May10_muon_count_10_cxx
