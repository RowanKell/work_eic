...
// Mon Mar 11 15:47:24 2024 by ROOT version 6.28/06
// from TTree events/events data tree
// found on file: root_files/ex_steering_epic.edm4hep.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxEcalBarrelImagingHits = 11;
   static constexpr Int_t kMax_EcalBarrelImagingHits_contributions = 32;
   static constexpr Int_t kMaxEcalBarrelImagingHitsContributions = 32;
   static constexpr Int_t kMax_EcalBarrelImagingHitsContributions_particle = 32;
   static constexpr Int_t kMaxEcalBarrelScFiHits = 231;
   static constexpr Int_t kMax_EcalBarrelScFiHits_contributions = 616;
   static constexpr Int_t kMaxEcalBarrelScFiHitsContributions = 616;
   static constexpr Int_t kMax_EcalBarrelScFiHitsContributions_particle = 616;
   static constexpr Int_t kMaxEcalEndcapNHits = 1;
   static constexpr Int_t kMax_EcalEndcapNHits_contributions = 1;
   static constexpr Int_t kMaxEcalEndcapNHitsContributions = 1;
   static constexpr Int_t kMax_EcalEndcapNHitsContributions_particle = 1;
   static constexpr Int_t kMaxEcalEndcapPHits = 1;
   static constexpr Int_t kMax_EcalEndcapPHits_contributions = 9;
   static constexpr Int_t kMaxEcalEndcapPHitsContributions = 9;
   static constexpr Int_t kMax_EcalEndcapPHitsContributions_particle = 9;
   static constexpr Int_t kMaxEcalEndcapPInsertHits = 1;
   static constexpr Int_t kMax_EcalEndcapPInsertHits_contributions = 1;
   static constexpr Int_t kMaxEcalEndcapPInsertHitsContributions = 1;
   static constexpr Int_t kMax_EcalEndcapPInsertHitsContributions_particle = 1;
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 11;
   static constexpr Int_t kMax_HcalBarrelHits_contributions = 79;
   static constexpr Int_t kMaxHcalBarrelHitsContributions = 79;
   static constexpr Int_t kMax_HcalBarrelHitsContributions_particle = 79;
   ...
   static constexpr Int_t kMaxLumiSpecCALHits = 1;
   static constexpr Int_t kMax_LumiSpecCALHits_contributions = 1;
   static constexpr Int_t kMaxLumiSpecCALHitsContributions = 1;
   static constexpr Int_t kMax_LumiSpecCALHitsContributions_particle = 1;
   static constexpr Int_t kMaxLumiSpecTrackerHits = 1;
   static constexpr Int_t kMax_LumiSpecTrackerHits_MCParticle = 1;
   static constexpr Int_t kMaxMCParticles = 5;
   static constexpr Int_t kMax_MCParticles_parents = 4;
   static constexpr Int_t kMax_MCParticles_daughters = 4;
   static constexpr Int_t kMaxMPGDBarrelHits = 7;
   static constexpr Int_t kMax_MPGDBarrelHits_MCParticle = 7;
   static constexpr Int_t kMaxMPGDDIRCHits = 2;
   static constexpr Int_t kMax_MPGDDIRCHits_MCParticle = 2;
   static constexpr Int_t kMaxPFRICHHits = 1;
   static constexpr Int_t kMax_PFRICHHits_MCParticle = 1;
   static constexpr Int_t kMaxSiBarrelHits = 7;
   static constexpr Int_t kMax_SiBarrelHits_MCParticle = 7;
   static constexpr Int_t kMaxTaggerTrackerHits = 1;
   static constexpr Int_t kMax_TaggerTrackerHits_MCParticle = 1;
   static constexpr Int_t kMaxTOFBarrelHits = 9;
   static constexpr Int_t kMax_TOFBarrelHits_MCParticle = 9;
   static constexpr Int_t kMaxTOFEndcapHits = 1;
   static constexpr Int_t kMax_TOFEndcapHits_MCParticle = 1;
   static constexpr Int_t kMaxTrackerEndcapHits = 1;
   static constexpr Int_t kMax_TrackerEndcapHits_MCParticle = 1;
   static constexpr Int_t kMaxVertexBarrelHits = 3;
   static constexpr Int_t kMax_VertexBarrelHits_MCParticle = 3;
   static constexpr Int_t kMaxZDCEcalHits = 1;
   static constexpr Int_t kMax_ZDCEcalHits_contributions = 1;
   static constexpr Int_t kMaxZDCEcalHitsContributions = 1;
   static constexpr Int_t kMax_ZDCEcalHitsContributions_particle = 1;
   ...
   Int_t           LumiSpecCALHits_;
   ULong_t         LumiSpecCALHits_cellID[kMaxLumiSpecCALHits];   //[LumiSpecCALHits_]
   Float_t         LumiSpecCALHits_energy[kMaxLumiSpecCALHits];   //[LumiSpecCALHits_]
   Float_t         LumiSpecCALHits_position_x[kMaxLumiSpecCALHits];   //[LumiSpecCALHits_]
   Float_t         LumiSpecCALHits_position_y[kMaxLumiSpecCALHits];   //[LumiSpecCALHits_]
   Float_t         LumiSpecCALHits_position_z[kMaxLumiSpecCALHits];   //[LumiSpecCALHits_]
   UInt_t          LumiSpecCALHits_contributions_begin[kMaxLumiSpecCALHits];   //[LumiSpecCALHits_]
   UInt_t          LumiSpecCALHits_contributions_end[kMaxLumiSpecCALHits];   //[LumiSpecCALHits_]
   Int_t           _LumiSpecCALHits_contributions_;
   Int_t           _LumiSpecCALHits_contributions_index[kMax_LumiSpecCALHits_contributions];   //[_LumiSpecCALHits_contributions_]
   UInt_t          _LumiSpecCALHits_contributions_collectionID[kMax_LumiSpecCALHits_contributions];   //[_LumiSpecCALHits_contributions_]
   Int_t           LumiSpecCALHitsContributions_;
   Int_t           LumiSpecCALHitsContributions_PDG[kMaxLumiSpecCALHitsContributions];   //[LumiSpecCALHitsContributions_]
   Float_t         LumiSpecCALHitsContributions_energy[kMaxLumiSpecCALHitsContributions];   //[LumiSpecCALHitsContributions_]
   Float_t         LumiSpecCALHitsContributions_time[kMaxLumiSpecCALHitsContributions];   //[LumiSpecCALHitsContributions_]
   Float_t         LumiSpecCALHitsContributions_stepPosition_x[kMaxLumiSpecCALHitsContributions];   //[LumiSpecCALHitsContributions_]
   Float_t         LumiSpecCALHitsContributions_stepPosition_y[kMaxLumiSpecCALHitsContributions];   //[LumiSpecCALHitsContributions_]
   Float_t         LumiSpecCALHitsContributions_stepPosition_z[kMaxLumiSpecCALHitsContributions];   //[LumiSpecCALHitsContributions_]
   Int_t           _LumiSpecCALHitsContributions_particle_;
   Int_t           _LumiSpecCALHitsContributions_particle_index[kMax_LumiSpecCALHitsContributions_particle];   //[_LumiSpecCALHitsContributions_particle_]
   UInt_t          _LumiSpecCALHitsContributions_particle_collectionID[kMax_LumiSpecCALHitsContributions_particle];   //[_LumiSpecCALHitsContributions_particle_]
   ...
   Int_t           ZDCEcalHits_;
   ULong_t         ZDCEcalHits_cellID[kMaxZDCEcalHits];   //[ZDCEcalHits_]
   Float_t         ZDCEcalHits_energy[kMaxZDCEcalHits];   //[ZDCEcalHits_]
   Float_t         ZDCEcalHits_position_x[kMaxZDCEcalHits];   //[ZDCEcalHits_]
   Float_t         ZDCEcalHits_position_y[kMaxZDCEcalHits];   //[ZDCEcalHits_]
   Float_t         ZDCEcalHits_position_z[kMaxZDCEcalHits];   //[ZDCEcalHits_]
   UInt_t          ZDCEcalHits_contributions_begin[kMaxZDCEcalHits];   //[ZDCEcalHits_]
   UInt_t          ZDCEcalHits_contributions_end[kMaxZDCEcalHits];   //[ZDCEcalHits_]
   Int_t           _ZDCEcalHits_contributions_;
   Int_t           _ZDCEcalHits_contributions_index[kMax_ZDCEcalHits_contributions];   //[_ZDCEcalHits_contributions_]
   UInt_t          _ZDCEcalHits_contributions_collectionID[kMax_ZDCEcalHits_contributions];   //[_ZDCEcalHits_contributions_]
   Int_t           ZDCEcalHitsContributions_;
   Int_t           ZDCEcalHitsContributions_PDG[kMaxZDCEcalHitsContributions];   //[ZDCEcalHitsContributions_]
   Float_t         ZDCEcalHitsContributions_energy[kMaxZDCEcalHitsContributions];   //[ZDCEcalHitsContributions_]
   Float_t         ZDCEcalHitsContributions_time[kMaxZDCEcalHitsContributions];   //[ZDCEcalHitsContributions_]
   Float_t         ZDCEcalHitsContributions_stepPosition_x[kMaxZDCEcalHitsContributions];   //[ZDCEcalHitsContributions_]
   Float_t         ZDCEcalHitsContributions_stepPosition_y[kMaxZDCEcalHitsContributions];   //[ZDCEcalHitsContributions_]
   Float_t         ZDCEcalHitsContributions_stepPosition_z[kMaxZDCEcalHitsContributions];   //[ZDCEcalHitsContributions_]
   Int_t           _ZDCEcalHitsContributions_particle_;
   Int_t           _ZDCEcalHitsContributions_particle_index[kMax_ZDCEcalHitsContributions_particle];   //[_ZDCEcalHitsContributions_particle_]
   UInt_t          _ZDCEcalHitsContributions_particle_collectionID[kMax_ZDCEcalHitsContributions_particle];   //[_ZDCEcalHitsContributions_particle_]
 //podio::GenericParameters *PARAMETERS;
   ...
   TBranch        *b_LumiSpecCALHits_;   //!
   TBranch        *b_LumiSpecCALHits_cellID;   //!
   TBranch        *b_LumiSpecCALHits_energy;   //!
   TBranch        *b_LumiSpecCALHits_position_x;   //!
   TBranch        *b_LumiSpecCALHits_position_y;   //!
   TBranch        *b_LumiSpecCALHits_position_z;   //!
   TBranch        *b_LumiSpecCALHits_contributions_begin;   //!
   TBranch        *b_LumiSpecCALHits_contributions_end;   //!
   TBranch        *b__LumiSpecCALHits_contributions_;   //!
   TBranch        *b__LumiSpecCALHits_contributions_index;   //!
   TBranch        *b__LumiSpecCALHits_contributions_collectionID;   //!
   TBranch        *b_LumiSpecCALHitsContributions_;   //!
   TBranch        *b_LumiSpecCALHitsContributions_PDG;   //!
   TBranch        *b_LumiSpecCALHitsContributions_energy;   //!
   TBranch        *b_LumiSpecCALHitsContributions_time;   //!
   TBranch        *b_LumiSpecCALHitsContributions_stepPosition_x;   //!
   TBranch        *b_LumiSpecCALHitsContributions_stepPosition_y;   //!
   TBranch        *b_LumiSpecCALHitsContributions_stepPosition_z;   //!
   TBranch        *b__LumiSpecCALHitsContributions_particle_;   //!
   TBranch        *b__LumiSpecCALHitsContributions_particle_index;   //!
   TBranch        *b__LumiSpecCALHitsContributions_particle_collectionID;   //!
   ...
   TBranch        *b_ZDCEcalHits_;   //!
   TBranch        *b_ZDCEcalHits_cellID;   //!
   TBranch        *b_ZDCEcalHits_energy;   //!
   TBranch        *b_ZDCEcalHits_position_x;   //!
   TBranch        *b_ZDCEcalHits_position_y;   //!
   TBranch        *b_ZDCEcalHits_position_z;   //!
   TBranch        *b_ZDCEcalHits_contributions_begin;   //!
   TBranch        *b_ZDCEcalHits_contributions_end;   //!
   TBranch        *b__ZDCEcalHits_contributions_;   //!
   TBranch        *b__ZDCEcalHits_contributions_index;   //!
   TBranch        *b__ZDCEcalHits_contributions_collectionID;   //!
   TBranch        *b_ZDCEcalHitsContributions_;   //!
   TBranch        *b_ZDCEcalHitsContributions_PDG;   //!
   TBranch        *b_ZDCEcalHitsContributions_energy;   //!
   TBranch        *b_ZDCEcalHitsContributions_time;   //!
   TBranch        *b_ZDCEcalHitsContributions_stepPosition_x;   //!
   TBranch        *b_ZDCEcalHitsContributions_stepPosition_y;   //!
   TBranch        *b_ZDCEcalHitsContributions_stepPosition_z;   //!
   TBranch        *b__ZDCEcalHitsContributions_particle_;   //!
   TBranch        *b__ZDCEcalHitsContributions_particle_index;   //!
   TBranch        *b__ZDCEcalHitsContributions_particle_collectionID;   //!
...
#ifdef ex_epic_cxx
ex_epic::ex_epic(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/ex_steering_epic_pi.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/ex_steering_epic_pi.edm4hep.root");
      }
...
Int_t ex_epic::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ex_epic::LoadTree(Long64_t entry)
{
...
void ex_epic::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("LumiSpecCALHits", &LumiSpecCALHits_, &b_LumiSpecCALHits_);
   fChain->SetBranchAddress("LumiSpecCALHits.cellID", &LumiSpecCALHits_cellID, &b_LumiSpecCALHits_cellID);
   fChain->SetBranchAddress("LumiSpecCALHits.energy", &LumiSpecCALHits_energy, &b_LumiSpecCALHits_energy);
   fChain->SetBranchAddress("LumiSpecCALHits.position.x", &LumiSpecCALHits_position_x, &b_LumiSpecCALHits_position_x);
   fChain->SetBranchAddress("LumiSpecCALHits.position.y", &LumiSpecCALHits_position_y, &b_LumiSpecCALHits_position_y);
   fChain->SetBranchAddress("LumiSpecCALHits.position.z", &LumiSpecCALHits_position_z, &b_LumiSpecCALHits_position_z);
   fChain->SetBranchAddress("LumiSpecCALHits.contributions_begin", &LumiSpecCALHits_contributions_begin, &b_LumiSpecCALHits_contributions_begin);
   fChain->SetBranchAddress("LumiSpecCALHits.contributions_end", &LumiSpecCALHits_contributions_end, &b_LumiSpecCALHits_contributions_end);
   fChain->SetBranchAddress("_LumiSpecCALHits_contributions", &_LumiSpecCALHits_contributions_, &b__LumiSpecCALHits_contributions_);
   fChain->SetBranchAddress("_LumiSpecCALHits_contributions.index", &_LumiSpecCALHits_contributions_index, &b__LumiSpecCALHits_contributions_index);
   fChain->SetBranchAddress("_LumiSpecCALHits_contributions.collectionID", &_LumiSpecCALHits_contributions_collectionID, &b__LumiSpecCALHits_contributions_collectionID);
   fChain->SetBranchAddress("LumiSpecCALHitsContributions", &LumiSpecCALHitsContributions_, &b_LumiSpecCALHitsContributions_);
   fChain->SetBranchAddress("LumiSpecCALHitsContributions.PDG", &LumiSpecCALHitsContributions_PDG, &b_LumiSpecCALHitsContributions_PDG);
   fChain->SetBranchAddress("LumiSpecCALHitsContributions.energy", &LumiSpecCALHitsContributions_energy, &b_LumiSpecCALHitsContributions_energy);
   fChain->SetBranchAddress("LumiSpecCALHitsContributions.time", &LumiSpecCALHitsContributions_time, &b_LumiSpecCALHitsContributions_time);
   fChain->SetBranchAddress("LumiSpecCALHitsContributions.stepPosition.x", &LumiSpecCALHitsContributions_stepPosition_x, &b_LumiSpecCALHitsContributions_stepPosition_x);
   fChain->SetBranchAddress("LumiSpecCALHitsContributions.stepPosition.y", &LumiSpecCALHitsContributions_stepPosition_y, &b_LumiSpecCALHitsContributions_stepPosition_y);
   fChain->SetBranchAddress("LumiSpecCALHitsContributions.stepPosition.z", &LumiSpecCALHitsContributions_stepPosition_z, &b_LumiSpecCALHitsContributions_stepPosition_z);
   fChain->SetBranchAddress("_LumiSpecCALHitsContributions_particle", &_LumiSpecCALHitsContributions_particle_, &b__LumiSpecCALHitsContributions_particle_);
   fChain->SetBranchAddress("_LumiSpecCALHitsContributions_particle.index", &_LumiSpecCALHitsContributions_particle_index, &b__LumiSpecCALHitsContributions_particle_index);
   fChain->SetBranchAddress("_LumiSpecCALHitsContributions_particle.collectionID", &_LumiSpecCALHitsContributions_particle_collectionID, &b__LumiSpecCALHitsContributions_particle_collectionID);
   ...
   fChain->SetBranchAddress("ZDCEcalHits", &ZDCEcalHits_, &b_ZDCEcalHits_);
   fChain->SetBranchAddress("ZDCEcalHits.cellID", &ZDCEcalHits_cellID, &b_ZDCEcalHits_cellID);
   fChain->SetBranchAddress("ZDCEcalHits.energy", &ZDCEcalHits_energy, &b_ZDCEcalHits_energy);
   fChain->SetBranchAddress("ZDCEcalHits.position.x", &ZDCEcalHits_position_x, &b_ZDCEcalHits_position_x);
   fChain->SetBranchAddress("ZDCEcalHits.position.y", &ZDCEcalHits_position_y, &b_ZDCEcalHits_position_y);
   fChain->SetBranchAddress("ZDCEcalHits.position.z", &ZDCEcalHits_position_z, &b_ZDCEcalHits_position_z);
   fChain->SetBranchAddress("ZDCEcalHits.contributions_begin", &ZDCEcalHits_contributions_begin, &b_ZDCEcalHits_contributions_begin);
   fChain->SetBranchAddress("ZDCEcalHits.contributions_end", &ZDCEcalHits_contributions_end, &b_ZDCEcalHits_contributions_end);
   fChain->SetBranchAddress("_ZDCEcalHits_contributions", &_ZDCEcalHits_contributions_, &b__ZDCEcalHits_contributions_);
   fChain->SetBranchAddress("_ZDCEcalHits_contributions.index", &_ZDCEcalHits_contributions_index, &b__ZDCEcalHits_contributions_index);
   fChain->SetBranchAddress("_ZDCEcalHits_contributions.collectionID", &_ZDCEcalHits_contributions_collectionID, &b__ZDCEcalHits_contributions_collectionID);
   fChain->SetBranchAddress("ZDCEcalHitsContributions", &ZDCEcalHitsContributions_, &b_ZDCEcalHitsContributions_);
   fChain->SetBranchAddress("ZDCEcalHitsContributions.PDG", &ZDCEcalHitsContributions_PDG, &b_ZDCEcalHitsContributions_PDG);
   fChain->SetBranchAddress("ZDCEcalHitsContributions.energy", &ZDCEcalHitsContributions_energy, &b_ZDCEcalHitsContributions_energy);
   fChain->SetBranchAddress("ZDCEcalHitsContributions.time", &ZDCEcalHitsContributions_time, &b_ZDCEcalHitsContributions_time);
   fChain->SetBranchAddress("ZDCEcalHitsContributions.stepPosition.x", &ZDCEcalHitsContributions_stepPosition_x, &b_ZDCEcalHitsContributions_stepPosition_x);
   fChain->SetBranchAddress("ZDCEcalHitsContributions.stepPosition.y", &ZDCEcalHitsContributions_stepPosition_y, &b_ZDCEcalHitsContributions_stepPosition_y);
   fChain->SetBranchAddress("ZDCEcalHitsContributions.stepPosition.z", &ZDCEcalHitsContributions_stepPosition_z, &b_ZDCEcalHitsContributions_stepPosition_z);
   fChain->SetBranchAddress("_ZDCEcalHitsContributions_particle", &_ZDCEcalHitsContributions_particle_, &b__ZDCEcalHitsContributions_particle_);
   fChain->SetBranchAddress("_ZDCEcalHitsContributions_particle.index", &_ZDCEcalHitsContributions_particle_index, &b__ZDCEcalHitsContributions_particle_index);
   fChain->SetBranchAddress("_ZDCEcalHitsContributions_particle.collectionID", &_ZDCEcalHitsContributions_particle_collectionID, &b__ZDCEcalHitsContributions_particle_collectionID);
...
void ex_epic::Show(Long64_t entry)
{
...
Int_t ex_epic::Cut(Long64_t entry)
{
