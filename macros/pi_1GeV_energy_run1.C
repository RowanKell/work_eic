#define pi_1GeV_energy_run1_cxx
#include "pi_1GeV_energy_run1.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void pi_1GeV_energy_run1::Loop()
{
    if (fChain == 0) return;
   ...
   TFile f("root_files/graphs/april_5/pi_1GeV_energy_run1.root","recreate");
   gr->Write();
   c1->Print("plots/april_5/pi_1GeV_energy_run1.svg");
}
