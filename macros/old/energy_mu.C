...
void energy_mu::Loop()
{
   ...
   gr->SetTitle("Average HcalBarrelHits in each layer 1000 events (mu- gun)");
   ...
   TFile f("root_files/graphs/mu_100_april_4.root","recreate");
   gr->Write();
   c1->Print("plots/april_4/mu_100.pdf");
}
