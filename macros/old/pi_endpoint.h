...
#ifndef pi_endpoint_h
#define pi_endpoint_h
...
#ifdef pi_endpoint_cxx
pi_endpoint::pi_endpoint(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/rowan/eic/work_eic/root_files/EPIC_KLM_1GeV_pi_50000.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/rowan/eic/work_eic/root_files/EPIC_KLM_1GeV_pi_50000.edm4hep.root");
      }
...
Int_t pi_endpoint::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pi_endpoint::LoadTree(Long64_t entry)
{
...
void pi_endpoint::Init(TTree *tree)
{
...
void pi_endpoint::Show(Long64_t entry)
{
...
Int_t pi_endpoint::Cut(Long64_t entry)
{
