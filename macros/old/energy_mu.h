...
// Fri Mar  8 16:44:02 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/EPIC_KLM_1GeV_K_1000.edm4hep.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 216;
   static constexpr Int_t kMax_HcalBarrelHits_contributions = 768;
   static constexpr Int_t kMaxHcalBarrelHitsContributions = 768;
   static constexpr Int_t kMax_HcalBarrelHitsContributions_particle = 768;
   static constexpr Int_t kMaxMCParticles = 10;
   static constexpr Int_t kMax_MCParticles_parents = 9;
   static constexpr Int_t kMax_MCParticles_daughters = 9;
...
#ifdef energy_mu_cxx
energy_mu::energy_mu(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/pi_100_april_4_run1.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/pi_100_april_4_run1.edm4hep.root");
      }
...
Int_t energy_mu::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t energy_mu::LoadTree(Long64_t entry)
{
...
void energy_mu::Init(TTree *tree)
{
...
void energy_mu::Show(Long64_t entry)
{
...
Int_t energy_mu::Cut(Long64_t entry)
{
