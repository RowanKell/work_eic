...
infiledir="${eicdir}/work_eic/root_files/June_9_2cm_1point8_ns_time_constant/slurm/run_0_vary_events_one_segment_param/"

rootname="preprocess_600_z_vals"
...
do
    ...
    content+="python3 ${eicdir}/work_eic/macros/NF_timing_modeling/preprocess_fast.py --infile ${infiledir}vary_p_z_th_events_filenum${i}_600_z_vals_20_mm_scint_1point8_ns_time_constant.edm4hep.root:events --outfile ${outputdir}Vary_p_events_filenum${num}_600_z_vals_20_mm_1point8_time_constant.pt --file_num ${num}\n"
    echo -e "$content" > $file 
