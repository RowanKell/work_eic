...
// Fri Mar 29 18:14:18 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/test_vis_EPIC.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef Visual_EPIC_h
#define Visual_EPIC_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxEcalBarrelImagingHits = 25;
   static constexpr Int_t kMax_EcalBarrelImagingHits_contributions = 59;
   static constexpr Int_t kMaxEcalBarrelImagingHitsContributions = 59;
   static constexpr Int_t kMax_EcalBarrelImagingHitsContributions_particle = 59;
   static constexpr Int_t kMaxEcalBarrelScFiHits = 269;
   static constexpr Int_t kMax_EcalBarrelScFiHits_contributions = 630;
   static constexpr Int_t kMaxEcalBarrelScFiHitsContributions = 630;
   static constexpr Int_t kMax_EcalBarrelScFiHitsContributions_particle = 630;
   ...
   static constexpr Int_t kMax_EcalEndcapPHits_contributions = 1;
   static constexpr Int_t kMaxEcalEndcapPHitsContributions = 1;
   static constexpr Int_t kMax_EcalEndcapPHitsContributions_particle = 1;
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 9;
   static constexpr Int_t kMax_HcalBarrelHits_contributions = 92;
   static constexpr Int_t kMaxHcalBarrelHitsContributions = 92;
   static constexpr Int_t kMax_HcalBarrelHitsContributions_particle = 92;
   ...
   static constexpr Int_t kMaxMPGDBarrelHits = 1;
   static constexpr Int_t kMax_MPGDBarrelHits_MCParticle = 1;
   ...
   static constexpr Int_t kMaxSiBarrelHits = 28;
   static constexpr Int_t kMax_SiBarrelHits_MCParticle = 28;
   static constexpr Int_t kMaxTaggerTrackerHits = 1;
   static constexpr Int_t kMax_TaggerTrackerHits_MCParticle = 1;
   static constexpr Int_t kMaxTOFBarrelHits = 5;
   static constexpr Int_t kMax_TOFBarrelHits_MCParticle = 5;
   ...
   static constexpr Int_t kMaxVertexBarrelHits = 11;
   static constexpr Int_t kMax_VertexBarrelHits_MCParticle = 11;
...
#ifdef Visual_EPIC_cxx
Visual_EPIC::Visual_EPIC(TTree *tree) : fChain(0) 
{
...
Visual_EPIC::~Visual_EPIC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Visual_EPIC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Visual_EPIC::LoadTree(Long64_t entry)
{
...
void Visual_EPIC::Init(TTree *tree)
{
...
void Visual_EPIC::Show(Long64_t entry)
{
...
Int_t Visual_EPIC::Cut(Long64_t entry)
{
