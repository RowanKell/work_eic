...

{
   ...
   cout << "nentries: " << nentries << "Max: " << max << "| Min: " << min << "\n";
   
   //TFile f("root_files/graphs/april_6/mu_5GeV_energy_run1.root","recreate");
   //gr->Write();
   //c1->Print("plots/april_6/mu_5GeV_energy_run1.svg");
}
