#define mu_5GeV_energy_run1_cxx
#include "mu_5GeV_energy_run1.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void mu_5GeV_energy_run1::Loop()
{
    if (fChain == 0) return;
    ...
    //weird - in root file the index 3 layer has value 1918.0999 but these get rounded to 1918.1 for some reason, while the others are not rounded
   ...
   cout << "processed " << curr_event << "events\n";
   ...
   gr->SetTitle("avg energy deposition in each layer 10000 events (5GeV mu- gun)");
