#define pi_energy_10000_april_4_cxx
#include "pi_energy_10000_april_4.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void pi_energy_10000_april_4::Loop()
{
    if (fChain == 0) return;
   ...
   gr->SetTitle("Avg energy dept in each layer 10000 events (pi- gun)");
   ...
   TFile f("root_files/graphs/pi_10000_april_4_pi.root","recreate");
   gr->Write();
   c1->Print("plots/april_4/pi_10000_pi.svg");
}
