...
// Thu Apr  4 19:54:54 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/pi_1000_april_4_run1.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef energy_pi_1000_h
#define energy_pi_1000_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 680;
   static constexpr Int_t kMax_HcalBarrelHits_contributions = 2343;
   static constexpr Int_t kMaxHcalBarrelHitsContributions = 2343;
   static constexpr Int_t kMax_HcalBarrelHitsContributions_particle = 2343;
   static constexpr Int_t kMaxMCParticles = 1161;
   static constexpr Int_t kMax_MCParticles_parents = 1160;
   static constexpr Int_t kMax_MCParticles_daughters = 1160;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   energy_pi_1000(TTree *tree=0);
   virtual ~energy_pi_1000();
...
#ifdef energy_pi_1000_cxx
energy_pi_1000::energy_pi_1000(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/pi_1000_april_4_run1.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/pi_1000_april_4_run1.edm4hep.root");
      }
...
energy_pi_1000::~energy_pi_1000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t energy_pi_1000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t energy_pi_1000::LoadTree(Long64_t entry)
{
...
void energy_pi_1000::Init(TTree *tree)
{
...
void energy_pi_1000::Show(Long64_t entry)
{
...
Int_t energy_pi_1000::Cut(Long64_t entry)
{
...
#endif // #ifdef energy_pi_1000_cxx
