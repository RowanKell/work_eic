#define energy_pi_1000_cxx
#include "energy_pi_1000.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void energy_pi_1000::Loop()
{
    if (fChain == 0) return;
   ...
   TFile f("root_files/graphs/pi_1000_april_4.root","recreate");
   gr->Write();
   c1->Print("plots/april_4/pi_1000.pdf");
