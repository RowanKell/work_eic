...
#ifndef pi_5GeV_energy_run1_h
#define pi_5GeV_energy_run1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   pi_5GeV_energy_run1(TTree *tree=0);
   virtual ~pi_5GeV_energy_run1();
...
#ifdef pi_5GeV_energy_run1_cxx
pi_5GeV_energy_run1::pi_5GeV_energy_run1(TTree *tree) : fChain(0) 
{
...
pi_5GeV_energy_run1::~pi_5GeV_energy_run1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t pi_5GeV_energy_run1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pi_5GeV_energy_run1::LoadTree(Long64_t entry)
{
...
void pi_5GeV_energy_run1::Init(TTree *tree)
{
...
Bool_t pi_5GeV_energy_run1::Notify()
{
...
void pi_5GeV_energy_run1::Show(Long64_t entry)
{
...
Int_t pi_5GeV_energy_run1::Cut(Long64_t entry)
{
...
#endif // #ifdef pi_5GeV_energy_run1_cxx
