...
// Thu Apr  4 20:34:55 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/mu_10000_april_4_run2_1_GeV.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef mu_1GeV_energy_h
#define mu_1GeV_energy_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 80;
   static constexpr Int_t kMax_HcalBarrelHits_contributions = 266;
   static constexpr Int_t kMaxHcalBarrelHitsContributions = 266;
   static constexpr Int_t kMax_HcalBarrelHitsContributions_particle = 266;
   static constexpr Int_t kMaxMCParticles = 120;
   static constexpr Int_t kMax_MCParticles_parents = 119;
   static constexpr Int_t kMax_MCParticles_daughters = 119;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   mu_1GeV_energy(TTree *tree=0);
   virtual ~mu_1GeV_energy();
...
#ifdef mu_1GeV_energy_cxx
mu_1GeV_energy::mu_1GeV_energy(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/mu_10000_april_4_run2_1_GeV.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/mu_10000_april_4_run2_1_GeV.edm4hep.root");
      }
...
mu_1GeV_energy::~mu_1GeV_energy()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t mu_1GeV_energy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mu_1GeV_energy::LoadTree(Long64_t entry)
{
...
void mu_1GeV_energy::Init(TTree *tree)
{
...
void mu_1GeV_energy::Show(Long64_t entry)
{
...
Int_t mu_1GeV_energy::Cut(Long64_t entry)
{
...
#endif // #ifdef mu_1GeV_energy_cxx
