...
loss_axs.legend()
loss_fig.savefig(Timing_path + "plots/loss/" + date + "/loss_vary_p_" + K_str + "_flows_" + hidden_layers_str + "hl_" + hidden_units_str + "hu_" + batch_size_str + "bs.pdf")

model.save(Timing_path + "models/" + date + "/vary_p_uniform_" + K_str + "_flows_" + hidden_layers_str + "hl_" + hidden_units_str + "hu_" + batch_size_str + "bs.pth")
...
torch.save(samples,Timing_path + "data/samples/ " + date + "/vary_p_uniform_" + K_str + "_flows_" + hidden_layers_str + "hl_" + hidden_units_str + "hu_" + batch_size_str + "bs.pt")
torch.save(eval_test_data,Timing_path + "data/test/ " + date + "/vary_p_uniform_" + K_str + "_flows_" + hidden_layers_str + "hl_" + hidden_units_str + "hu_" + batch_size_str + "bs.pt")
...
sample_fig.show()
sample_fig.savefig(Timing_path + "plots/test_distributions/" + date + "/vary_p_uniform_" + K_str + "_flows_" + hidden_layers_str + "hl_" + hidden_units_str + "hu_" + batch_size_str + "bs.pdf")