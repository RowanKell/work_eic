...
torch.save(train_data,Timing_path + "data/combined/August_6/onesix_600_z_pos_train.pt")
torch.save(test_data,Timing_path + "data/combined/August_6/onesix_600_z_pos_test.pt")
torch.save(val_data,Timing_path + "data/combined/August_6/onesix_600_z_pos_val.pt")

# train_data = torch.load(Timing_path + "data/combined/August_6/tenth_600_z_pos_train.pt")
# test_data = torch.load(Timing_path + "data/combined/August_6/tenth_600_z_pos_test.pt")
# val_data = torch.load(Timing_path + "data/combined/August_6/tenth_600_z_pos_val.pt")
