...
// Fri Apr  5 11:54:44 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/pi_10000_april_5_run1_1_GeV.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef pi_10000_april_5_1_GeV_h
#define pi_10000_april_5_1_GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 667;
   static constexpr Int_t kMax_HcalBarrelHits_contributions = 2468;
   static constexpr Int_t kMaxHcalBarrelHitsContributions = 2468;
   static constexpr Int_t kMax_HcalBarrelHitsContributions_particle = 2468;
   static constexpr Int_t kMaxMCParticles = 1171;
   static constexpr Int_t kMax_MCParticles_parents = 1170;
   static constexpr Int_t kMax_MCParticles_daughters = 1170;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   pi_10000_april_5_1_GeV(TTree *tree=0);
   virtual ~pi_10000_april_5_1_GeV();
...
#ifdef pi_10000_april_5_1_GeV_cxx
pi_10000_april_5_1_GeV::pi_10000_april_5_1_GeV(TTree *tree) : fChain(0) 
{
...
pi_10000_april_5_1_GeV::~pi_10000_april_5_1_GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t pi_10000_april_5_1_GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pi_10000_april_5_1_GeV::LoadTree(Long64_t entry)
{
...
void pi_10000_april_5_1_GeV::Init(TTree *tree)
{
...
Bool_t pi_10000_april_5_1_GeV::Notify()
{
...
void pi_10000_april_5_1_GeV::Show(Long64_t entry)
{
...
Int_t pi_10000_april_5_1_GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef pi_10000_april_5_1_GeV_cxx
