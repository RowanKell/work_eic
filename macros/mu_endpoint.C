#define mu_endpoint_cxx
#include "mu_endpoint.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void mu_endpoint::Loop()
{
  if (fChain == 0) return;
  ...
  double x;
  double y;
  TH1F *h1 = new TH1F("hmu","radial position;r;counts",100,1500,3000);
  ...
  TFile f("root_files/histos/mu_hist.root","recreate");
  h1->Write();
}
