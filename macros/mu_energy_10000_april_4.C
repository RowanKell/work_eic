#define mu_energy_10000_april_4_cxx
#include "mu_energy_10000_april_4.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void mu_energy_10000_april_4::Loop()
{
    if (fChain == 0) return;
   ...
   gr->SetTitle("avg energy deposition in each layer 10000 events (mu- gun)");
   ...
   TFile f("root_files/graphs/mu_10000_april_4.root","recreate");
   gr->Write();
   c1->Print("plots/april_4/mu_10000_mu.pdf");
}
