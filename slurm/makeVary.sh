...
do
    ...
    content+="/usr/local/bin/ddsim --steeringFile ../work_eic/steering/variation_scint.py --compactFile /cwork/rck32/eic/epic_klm/epic_klmws_only.xml -G -N 10000 --gun.particle \"mu-\" --outputFile ../work_eic/root_files/June_18/variation_sector_scint_uniform/mu/variation_10kevents_file_${i}.edm4hep.root --part.userParticleHandler=\"\" --gun.position \"(0.0, 0.0, -400.0)\" --gun.thetaMin \"102.73\" --gun.thetaMax "102.73"\n"
    content+="EOF\n"
    echo -e "$content" > $file 
