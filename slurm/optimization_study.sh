...
#SBATCH --job-name=optimize_October_22_pim_run_3
...
python3 /hpc/group/vossenlab/rck32/eic/work_eic/macros/Timing_estimation/hyperparameter_study.py --inputTensorPath /hpc/group/vossenlab/rck32/eic/work_eic/macros/Timing_estimation/data/momentum_prediction_pulse/October_21/input/ --outputTensorPath /hpc/group/vossenlab/rck32/eic/work_eic/macros/Timing_estimation/data/momentum_prediction_pulse/October_21/output/ --basePath /hpc/group/vossenlab/rck32/eic/work_eic/macros/Timing_estimation/hyper_param_optim_run_3 --n_trials 200
