...
/usr/local/bin/ddsim --steeringFile ../work_eic/steering/variation_pos.py --compactFile /cwork/rck32/eic/epic_klm/epic_klmws_only.xml -G -N 4000 --gun.particle "mu-" --outputFile ../work_eic/root_files/July_1/slurm/mu_vary_z_theta/5GeV_200events_6.edm4hep.root --part.userParticleHandler="" --gun.position "(1769.3, 0.0, -282.300000)" --gun.thetaMin "0.00953" --gun.thetaMax "3.11936"
EOF
