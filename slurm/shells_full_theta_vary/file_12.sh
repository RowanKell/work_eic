...
/usr/local/bin/ddsim --steeringFile ../work_eic/steering/variation_pos.py --compactFile /cwork/rck32/eic/epic_klm/epic_klmws_only.xml -G -N 4000 --gun.particle "mu-" --outputFile ../work_eic/root_files/July_2/slurm/mu_vary_z_theta_no_save_all/5GeV_4000events_12.edm4hep.root --part.userParticleHandler="" --gun.position "(1769.3, 0.0, 167.400000)" --gun.thetaMin "0.01668" --gun.thetaMax "3.13048"
EOF
