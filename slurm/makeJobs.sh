...
do
    ...
    content+="/usr/local/bin/ddsim --steeringFile simulations/steering/npsim_local3.py --compactFile /cwork/rck32/eic/epic_klm/epic_klmws_only.xml -G -N 50 --gun.particle \"pi-\" --outputFile ${outputdir}pi_5GeV_30events_run_0_file_${i}.edm4hep.root --part.userParticleHandler=\"\"\n"
    content+="EOF\n"
    echo -e "$content" > $file 
