...
// Wed May  8 17:39:41 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/May8_mu_1GeV_100events_run_1.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef Muon_optical_1GeV_h
#define Muon_optical_1GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 2963;
   static constexpr Int_t kMax_HcalBarrelHits_MCParticle = 2963;
   static constexpr Int_t kMaxMCParticles = 21996;
   static constexpr Int_t kMax_MCParticles_parents = 21995;
   static constexpr Int_t kMax_MCParticles_daughters = 21995;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   Muon_optical_1GeV(TTree *tree=0);
   virtual ~Muon_optical_1GeV();
...
#ifdef Muon_optical_1GeV_cxx
Muon_optical_1GeV::Muon_optical_1GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/May8_mu_1GeV_100events_run_1.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/May8_mu_1GeV_100events_run_1.edm4hep.root");
      }
...
Muon_optical_1GeV::~Muon_optical_1GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Muon_optical_1GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Muon_optical_1GeV::LoadTree(Long64_t entry)
{
...
void Muon_optical_1GeV::Init(TTree *tree)
{
...
Bool_t Muon_optical_1GeV::Notify()
{
...
void Muon_optical_1GeV::Show(Long64_t entry)
{
...
Int_t Muon_optical_1GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef Muon_optical_1GeV_cxx
