...
// Fri Apr  5 11:10:28 2024 by ROOT version 6.28/06
// from TTree events/events data tree
// found on file: root_files/n_10000_april_5_run1_5_GeV.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef n_energy_10000_april_5_run1_5_GeV_h
#define n_energy_10000_april_5_run1_5_GeV_h
...
class n_energy_10000_april_5_run1_5_GeV {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 619;
   static constexpr Int_t kMax_HcalBarrelHits_contributions = 2362;
   static constexpr Int_t kMaxHcalBarrelHitsContributions = 2362;
   static constexpr Int_t kMax_HcalBarrelHitsContributions_particle = 2362;
   static constexpr Int_t kMaxMCParticles = 940;
   static constexpr Int_t kMax_MCParticles_parents = 939;
   static constexpr Int_t kMax_MCParticles_daughters = 939;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   n_energy_10000_april_5_run1_5_GeV(TTree *tree=0);
   virtual ~n_energy_10000_april_5_run1_5_GeV();
...
#ifdef n_energy_10000_april_5_run1_5_GeV_cxx
n_energy_10000_april_5_run1_5_GeV::n_energy_10000_april_5_run1_5_GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/n_10000_april_5_run1_5_GeV.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/n_10000_april_5_run1_5_GeV.edm4hep.root");
      }
...
n_energy_10000_april_5_run1_5_GeV::~n_energy_10000_april_5_run1_5_GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t n_energy_10000_april_5_run1_5_GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t n_energy_10000_april_5_run1_5_GeV::LoadTree(Long64_t entry)
{
...
void n_energy_10000_april_5_run1_5_GeV::Init(TTree *tree)
{
...
Bool_t n_energy_10000_april_5_run1_5_GeV::Notify()
{
...
void n_energy_10000_april_5_run1_5_GeV::Show(Long64_t entry)
{
...
Int_t n_energy_10000_april_5_run1_5_GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef n_energy_10000_april_5_run1_5_GeV_cxx
