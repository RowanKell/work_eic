...
// Wed May  8 16:29:11 2024 by ROOT version 6.30/02
// from TTree events/events data tree
// found on file: root_files/May8_mu_5GeV_100events_run_1.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef Muon_optical_100_h
#define Muon_optical_100_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 4217;
   static constexpr Int_t kMax_HcalBarrelHits_MCParticle = 4217;
   static constexpr Int_t kMaxMCParticles = 39973;
   static constexpr Int_t kMax_MCParticles_parents = 39972;
   static constexpr Int_t kMax_MCParticles_daughters = 39972;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   Muon_optical_100(TTree *tree=0);
   virtual ~Muon_optical_100();
...
#ifdef Muon_optical_100_cxx
Muon_optical_100::Muon_optical_100(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/May8_mu_5GeV_100events_run_1.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/May8_mu_5GeV_100events_run_1.edm4hep.root");
      }
...
Muon_optical_100::~Muon_optical_100()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Muon_optical_100::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Muon_optical_100::LoadTree(Long64_t entry)
{
...
void Muon_optical_100::Init(TTree *tree)
{
...
Bool_t Muon_optical_100::Notify()
{
...
void Muon_optical_100::Show(Long64_t entry)
{
...
Int_t Muon_optical_100::Cut(Long64_t entry)
{
...
#endif // #ifdef Muon_optical_100_cxx
