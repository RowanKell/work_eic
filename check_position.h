...
// Thu May  9 16:15:03 2024 by ROOT version 6.28/10
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   check_position(TTree *tree=0);
   virtual ~check_position();
...
#ifdef check_position_cxx
check_position::check_position(TTree *tree) : fChain(0) 
{
...
Int_t check_position::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t check_position::LoadTree(Long64_t entry)
{
...
void check_position::Init(TTree *tree)
{
...
void check_position::Show(Long64_t entry)
{
...
Int_t check_position::Cut(Long64_t entry)
{
...
#endif // #ifdef check_position_cxx
