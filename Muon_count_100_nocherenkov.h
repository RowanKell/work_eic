...
// Thu May  9 17:53:22 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/May9_mu_5GeV_100events_nocherenkov_run_1.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef Muon_count_100_nocherenkov_h
#define Muon_count_100_nocherenkov_h
...
class Muon_count_100_nocherenkov {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 203;
   static constexpr Int_t kMax_HcalBarrelHits_MCParticle = 203;
   static constexpr Int_t kMaxMCParticles = 4110;
   static constexpr Int_t kMax_MCParticles_parents = 4109;
   static constexpr Int_t kMax_MCParticles_daughters = 4109;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   Muon_count_100_nocherenkov(TTree *tree=0);
   virtual ~Muon_count_100_nocherenkov();
...
#ifdef Muon_count_100_nocherenkov_cxx
Muon_count_100_nocherenkov::Muon_count_100_nocherenkov(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/May9_mu_5GeV_100events_nocherenkov_run_1.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/May9_mu_5GeV_100events_nocherenkov_run_1.edm4hep.root");
      }
...
Muon_count_100_nocherenkov::~Muon_count_100_nocherenkov()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Muon_count_100_nocherenkov::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Muon_count_100_nocherenkov::LoadTree(Long64_t entry)
{
...
void Muon_count_100_nocherenkov::Init(TTree *tree)
{
...
Bool_t Muon_count_100_nocherenkov::Notify()
{
...
void Muon_count_100_nocherenkov::Show(Long64_t entry)
{
...
Int_t Muon_count_100_nocherenkov::Cut(Long64_t entry)
{
...
#endif // #ifdef Muon_count_100_nocherenkov_cxx
