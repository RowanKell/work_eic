#define Pi_optical_100_cxx
#include "Pi_optical_100.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Pi_optical_100::Loop()

{
   ...
   std::string text = "avg # of hits in each layer 100 events (5GeV pi- gun) | total: ";
   text += std::to_string(avg_count_total);
   cout << "text: " << text << "\n";
   
   std::string mc_text = "avg # of -22 PDG in each layer 100 events (5GeV pi- gun) | total: ";
   ...
   //gr->Write();
   c1->Print("plots/May_7/pi_5GeV_energy_100_run1.svg");
