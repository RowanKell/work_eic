...
// Thu May  9 16:47:23 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/May9_mu_5GeV_1000events_run_1.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef Muon_counts_1000_May_9_h
#define Muon_counts_1000_May_9_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 5901;
   static constexpr Int_t kMax_HcalBarrelHits_MCParticle = 5901;
   static constexpr Int_t kMaxMCParticles = 54516;
   static constexpr Int_t kMax_MCParticles_parents = 54515;
   static constexpr Int_t kMax_MCParticles_daughters = 54515;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   Muon_counts_1000_May_9(TTree *tree=0);
   virtual ~Muon_counts_1000_May_9();
...
#ifdef Muon_counts_1000_May_9_cxx
Muon_counts_1000_May_9::Muon_counts_1000_May_9(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/May9_mu_5GeV_1000events_run_1.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/May9_mu_5GeV_1000events_run_1.edm4hep.root");
      }
...
Muon_counts_1000_May_9::~Muon_counts_1000_May_9()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Muon_counts_1000_May_9::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Muon_counts_1000_May_9::LoadTree(Long64_t entry)
{
...
void Muon_counts_1000_May_9::Init(TTree *tree)
{
...
Bool_t Muon_counts_1000_May_9::Notify()
{
...
void Muon_counts_1000_May_9::Show(Long64_t entry)
{
...
Int_t Muon_counts_1000_May_9::Cut(Long64_t entry)
{
...
#endif // #ifdef Muon_counts_1000_May_9_cxx
