...
// Thu May  9 17:30:42 2024 by ROOT version 6.30/02
// from TTree events/events data tree
// found on file: root_files/May9_pi_5GeV_1000events_run_1.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef Pion_counts_1000_May9_h
#define Pion_counts_1000_May9_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 18242;
   static constexpr Int_t kMax_HcalBarrelHits_MCParticle = 18242;
   static constexpr Int_t kMaxMCParticles = 103480;
   static constexpr Int_t kMax_MCParticles_parents = 103479;
   static constexpr Int_t kMax_MCParticles_daughters = 103479;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   Pion_counts_1000_May9(TTree *tree=0);
   virtual ~Pion_counts_1000_May9();
...
#ifdef Pion_counts_1000_May9_cxx
Pion_counts_1000_May9::Pion_counts_1000_May9(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/May9_pi_5GeV_1000events_run_1.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/May9_pi_5GeV_1000events_run_1.edm4hep.root");
      }
...
Pion_counts_1000_May9::~Pion_counts_1000_May9()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Pion_counts_1000_May9::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Pion_counts_1000_May9::LoadTree(Long64_t entry)
{
...
void Pion_counts_1000_May9::Init(TTree *tree)
{
...
Bool_t Pion_counts_1000_May9::Notify()
{
...
void Pion_counts_1000_May9::Show(Long64_t entry)
{
...
Int_t Pion_counts_1000_May9::Cut(Long64_t entry)
{
...
#endif // #ifdef Pion_counts_1000_May9_cxx
