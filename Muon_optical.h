...
// Wed May  8 14:13:37 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/mu_1GeV_energy_run1_1_may_7.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef Muon_optical_h
#define Muon_optical_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 1754;
   static constexpr Int_t kMax_HcalBarrelHits_MCParticle = 1754;
   static constexpr Int_t kMaxMCParticles = 16716;
   static constexpr Int_t kMax_MCParticles_parents = 16715;
   static constexpr Int_t kMax_MCParticles_daughters = 16715;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   Muon_optical(TTree *tree=0);
   virtual ~Muon_optical();
...
#ifdef Muon_optical_cxx
Muon_optical::Muon_optical(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/mu_1GeV_energy_run1_1_may_7.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/mu_1GeV_energy_run1_1_may_7.edm4hep.root");
      }
...
Muon_optical::~Muon_optical()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Muon_optical::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Muon_optical::LoadTree(Long64_t entry)
{
...
void Muon_optical::Init(TTree *tree)
{
...
void Muon_optical::Show(Long64_t entry)
{
...
Int_t Muon_optical::Cut(Long64_t entry)
{
