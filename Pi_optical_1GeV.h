...
// Wed May  8 17:43:24 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/May8_pi_1GeV_100events_run_1.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef Pi_optical_1GeV_h
#define Pi_optical_1GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 4002;
   static constexpr Int_t kMax_HcalBarrelHits_MCParticle = 4002;
   static constexpr Int_t kMaxMCParticles = 29585;
   static constexpr Int_t kMax_MCParticles_parents = 29584;
   static constexpr Int_t kMax_MCParticles_daughters = 29584;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   Pi_optical_1GeV(TTree *tree=0);
   virtual ~Pi_optical_1GeV();
...
#ifdef Pi_optical_1GeV_cxx
Pi_optical_1GeV::Pi_optical_1GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/May8_pi_1GeV_100events_run_1.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/May8_pi_1GeV_100events_run_1.edm4hep.root");
      }
...
Pi_optical_1GeV::~Pi_optical_1GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Pi_optical_1GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Pi_optical_1GeV::LoadTree(Long64_t entry)
{
...
void Pi_optical_1GeV::Init(TTree *tree)
{
...
void Pi_optical_1GeV::Show(Long64_t entry)
{
...
Int_t Pi_optical_1GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef Pi_optical_1GeV_cxx
