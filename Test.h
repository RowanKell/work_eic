...
// Sat Apr  6 17:16:01 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/mu_1_april_4.edm4hep.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 36;
   static constexpr Int_t kMax_HcalBarrelHits_contributions = 127;
   static constexpr Int_t kMaxHcalBarrelHitsContributions = 127;
   static constexpr Int_t kMax_HcalBarrelHitsContributions_particle = 127;
   static constexpr Int_t kMaxMCParticles = 78;
   static constexpr Int_t kMax_MCParticles_parents = 77;
   static constexpr Int_t kMax_MCParticles_daughters = 77;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/mu_1_april_4.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/mu_1_april_4.edm4hep.root");
      }
