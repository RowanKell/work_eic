...
// Thu May  9 17:48:22 2024 by ROOT version 6.28/10
// from TTree events/events data tree
// found on file: root_files/May9_mu_5GeV_100events_noscint_run_1.edm4hep.root
//////////////////////////////////////////////////////////

#ifndef Muon_count_100_noscint_h
#define Muon_count_100_noscint_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxHcalBarrelHits = 4995;
   static constexpr Int_t kMax_HcalBarrelHits_MCParticle = 4995;
   static constexpr Int_t kMaxMCParticles = 44095;
   static constexpr Int_t kMax_MCParticles_parents = 44094;
   static constexpr Int_t kMax_MCParticles_daughters = 44094;
 ...
 //podio::GenericParameters *PARAMETERS;
   ...
   Muon_count_100_noscint(TTree *tree=0);
   virtual ~Muon_count_100_noscint();
...
#ifdef Muon_count_100_noscint_cxx
Muon_count_100_noscint::Muon_count_100_noscint(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_files/May9_mu_5GeV_100events_noscint_run_1.edm4hep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_files/May9_mu_5GeV_100events_noscint_run_1.edm4hep.root");
      }
...
Muon_count_100_noscint::~Muon_count_100_noscint()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Muon_count_100_noscint::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Muon_count_100_noscint::LoadTree(Long64_t entry)
{
...
void Muon_count_100_noscint::Init(TTree *tree)
{
...
Bool_t Muon_count_100_noscint::Notify()
{
...
void Muon_count_100_noscint::Show(Long64_t entry)
{
...
Int_t Muon_count_100_noscint::Cut(Long64_t entry)
{
...
#endif // #ifdef Muon_count_100_noscint_cxx
